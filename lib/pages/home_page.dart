...
//     AuthGoogle authGoogle = await AuthGoogle(fileJson: "assets/dialogflow_key.json").build();
...
//                 return _buildMessageItem(_messages[index]['message'], _messages[index]['data']);
//               },
//             ),
//           ),
//           Divider(height: 1.0),
...
//               child: Text(
//                 message,
//                 style: TextStyle(color: data == 1 ? Colors.white : Colors.black),
//               ),
//             ),
//           ),
//         ],
